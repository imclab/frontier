...
//            this.uiLayer.systemManager.add(new RadarSystem(this.gameLayer));  disabled; not ported yet
...
//            this.uiLayer.systemManager.add(new RadarSystem(this.gameLayer));
        ...
        startLevel:function (level)
        {
            ...
            // load up the map
            this.loadFromTMX(pc.device.loader.get('level' + this.level).resource);
            this.spaceStationLayer = this.get('Tile Layer 1');
...
//            this.radarLayer.setLayers(this.spaceStationLayer, this.gameLayer);
            ...
            // keep track of the player entity (for parallax and basic controls)
        ...
        process:function ()
        {
          ...
          // todo: move this over to an input component for the player entity -- it will let us do cool things later
          // like take over piloting another ship
